...
extension Notification.Name {
    ...
    static let arcATCSuffixesSettingChanged = Notification.Name("arcATCSuffixesSettingChanged")
    static let hotkeyOnlyModeChanged = Notification.Name("hotkeyOnlyModeChanged")
}
